...
export class UiPaginator {
    ...
    return [
      ...
      <button
        ...
        onClick={this.goToPage.bind(
          this,
          this.currentPage + 1 >= this.numberPages ? this.numberPages : this.currentPage + 1
        )}></button>
    ];
  }
  ...
  getNumberButtons() {
    //-x + 4
    let firstPage =
      this.currentPage - (this.numberPages - this.currentPage < 2 ? -(this.numberPages - this.currentPage) + 4 : 2);
    ...
    for (let i = firstPage; i <= lastPage; i++) {
      numbersButtons.push(
        <button class={i === this.currentPage ? 'current' : ''} onClick={this.goToPage.bind(this, i)}>
          {i}
        </button>
      );
    }
      ...
      <div class='paginator-content'>
        <div class='center-container'>
          <div class='button-content'>
            <div class='go-to-page-content'>{goToPageContent}</div>
          ...
          <div class='item-page'>{itemsPerPageSelect}</div>
        </div>
      </div>
    );
  }
